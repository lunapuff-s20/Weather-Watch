...
function updateWeatherBackground(weatherCondition) {
    ...
    if (condition.includes('rain') || condition.includes('drizzle')) {
        ...
        // Create realistic individual raindrops
        for (let i = 0; i < 50; i++) {
        ...
        background.style.background = 'linear-gradient(135deg,rgb(141, 145, 149) 0%,rgb(107, 152, 157) 50%,rgb(120, 130, 130) 100%)';
    } else if (condition.includes('clear') || condition.includes('sun')) {
        animation.classList.add('sunny-animation');
        background.style.background = 'linear-gradient(135deg,rgb(255, 233, 155) 0%,rgb(73, 146, 194) 100%)';
